...
# Telco_Customer_Churn_Prediction_App.py

import streamlit as st
import pandas as pd
import joblib
import cloudpickle   # ✅ fallback loader
import os
...
try:
    # Try loading with joblib (your original line preserved)
    catboost_pipeline = joblib.load("catboost_pipeline.pkl")
except Exception as e:
    st.warning(f"⚠️ joblib failed to load model, trying cloudpickle... ({e})")
